...
<body>
    <div class="generic-container">
        ...
        <%@include file="sideNav.jsp" %>  
         ...
         <div class="well lead">Teacher Subject</div>
        ...
        <div class="row">
                <div class="form-group col-md-12">
                    <label class="col-md-3 control-lable" for=users>Teacher</label>
                    <div class="col-md-7">
                    <form:checkboxes element="li" items="${teachers}" path="teacherSubjects" itemValue="id" itemLabel="firstName"/>
                     <div class="has-error">
                            <form:errors path="teacherSubjects" class="help-inline"/>
