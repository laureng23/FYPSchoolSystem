...
<head>
    ...
    <title>Add Student To Base Group</title>
...
<body>
    <div class="generic-container">
        <%@include file="authheader.jsp" %>
         ...
         <div class="well lead">Add Student To Base Group</div>
     ...
     <div class="row">
            ...
            <div class="row">
                <div class="form-group col-md-12">
                    ...
                    <div class="col-md-7">
                    <form:select path="userBaseGroups" items="${students}" multiple="false" itemValue="id" itemLabel="firstName" class="form-control input-sm" />
                        <div class="has-error">
                            <form:errors path="userBaseGroups" class="help-inline"/>
            ...
            <div class="row">
                <div class="form-actions floatRight">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <input type="submit" value="Register Student" class="btn btn-primary btn-sm"/> or <a href="<c:url value='/baseGroupList' />">Cancel</a>
                        </c:otherwise>
                    </c:choose>
                </div>
            </div>
