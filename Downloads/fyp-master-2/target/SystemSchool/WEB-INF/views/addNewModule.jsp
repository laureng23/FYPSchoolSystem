...
<head>
    ...
    <title>Module Registration Form</title>
...
<body>
    <div class="generic-container">
        <%@include file="authheader.jsp" %>
         ...
         <div class="well lead">Module Registration Form</div>
	...
	<div class="row">
            ...
            <div class="row">
                <div class="form-actions floatRight">
                    <c:choose>
                        <c:when test="${edit}">
                            <input type="submit" value="UpdateModule" class="btn btn-primary btn-sm"/> or <a href="<c:url value='/moduleList' />">Cancel</a>
                        </c:when>
                        <c:otherwise>
                            <input type="submit" value="RegisterModule" class="btn btn-primary btn-sm"/> or <a href="<c:url value='/moduleList' />">Cancel</a>
                        </c:otherwise>
                    </c:choose>
                </div>
            </div>
